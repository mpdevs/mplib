USE t_elengjing;
ADD FILE /home/udflib/serverudf/elengjing/udf_pair_train_feature1.py;
DROP TABLE IF EXISTS competitive_item_train_stage_1;
CREATE TABLE competitive_item_train_stage_1(customer_item_id STRING, target_item_id STRING, similarity STRING, score STRING) STORED AS ORC;
INSERT INTO competitive_item_train_stage_1
SELECT TRANSFORM(ct.data, tt.data, ct.itemid, tt.itemid, l.score)
USING 'python udf_pair_train_feature1.py 1623' AS (customer_item_id, target_item_id, similarity, score)
